...
class Circuit:
    ...
    def __measure_tonedisc_fitness(self, waveform, state):
        ...
        for i in range(len(waveform)):
            ...
            difference = abs(1024 - waveformPoint) if statePoint == 1 else waveformPoint
        ...
        if waveform_sum == 0:
            ...
            self.__fitness = 1 / difference_sum
            if (self.__fitness < 0.00001):
                self.__fitness = stdev(waveform)
            else:
                self.__fitness += 500
                self.__fitness += 500 * (self.__fitness)
        self.__mean_voltage = sum(waveform) / len(waveform) #used by combined fitness func
